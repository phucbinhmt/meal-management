            ...
            <div class="col-9">
                <div class="card card-main border-0 h-100 shadow-sm">
                    <div class="card-header mt-3 border-0 pb-0">
                        ...
                        <div class="row px-2">
                            <div class="col-auto">
                                <a href="{{ route('plans.edit', [$date, $session]) }}" class="btn btn-primary"
                                    role="button">Cập
                                    nhật</a>
                            </div>
                            <div class="col">
                                <div class="row g-2 justify-content-end">
                                    ...
                                    <div class="col-auto">
                                        <a href="{{ route('plans.show', [$date_parse->copy()->subDay()->format('Y-m-d'),1]) }}"
                                            role="button" class="btn btn-icon btn-primary">
                                            <i class="fa-regular fa-angle-left"></i>
                                        </a>
                                    </div>
                                    <div class="col-auto">
                                        <a href="{{ route('plans.show', [$date_parse->copy()->addDay()->format('Y-m-d'),1]) }}"
                                            role="button" class="btn btn-icon btn-primary">
                                    ...
                                    <div class="col d-flex justify-content-center">
                                        <div class="card card-dish shadow-sm border-0">
                                            ...
                                            <div class="card-img-overlay p-0">
                                                <span class="text-description text-bg-info px-2 rounded">Số lượng:
                                                    {{ $dish->pivot->quantity }}</span>
                                            </div>
                                ...
                                <div class="col-12 d-flex justify-content-center">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Không có món ăn nào trong suất ăn</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
