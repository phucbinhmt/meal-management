                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-select @error('gender') is-invalid @enderror"
                                                    ...
                                                    <option value="{{ config('constants.MALE_GENDER') }}"
                                                        @if (old('gender', $user->gender) == config('constants.MALE_GENDER')) selected @endif>
                                                        Nam
                                                    </option>
                                                    <option value="{{ config('constants.FEMALE_GENDER') }}"
                                                        @if (old('gender', $user->gender) == config('constants.FEMALE_GENDER')) selected @endif>
                                                        Nữ
                                                    </option>
                                                </select>
                                                @error('gender')
                                                ...
                                                <select class="form-select @error('address_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($addresses as $address)
                                                        <option value="{{ $address->address_id }}"
                                                            @if (old('address_id', $user->address_id) == $address->address_id) selected @endif>
                                                ...
                                                <select class="form-select @error('position_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($positions as $position)
                                                        <option value="{{ $position->position_id }}"
                                                            @if (old('position_id', $user->position_id) == $position->position_id) selected @endif>
