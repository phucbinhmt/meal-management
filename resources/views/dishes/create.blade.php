                            ...
                            <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="dish_name" id="dish_name"
                                                    ...
                                                    placeholder="Nhập tên món ăn" value="{{ old('dish_name') }}">
                                                @error('dish_name')
                                                ...
                                                <select class="form-select @error('dish_type_id') is-invalid @enderror"
                                                    ...
                                                    @foreach ($dish_types as $dish_type)
                                                        <option value="{{ $dish_type->dish_type_id }}"
                                                            @if (old('dish_type_id') == $dish_type->dish_type_id) selected @endif>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="price" id="price"
                                                    ...
                                                    placeholder="Nhập giá bán" value="{{ old('price') }}">
                                                @error('price')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                                    placeholder="Nhập mô tả" rows="5">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="col-4 ps-4">
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-center">
                                            <img src="{{ asset('images/dishes/dish-placeholder.jpg') }}"
